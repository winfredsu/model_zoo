...
flags.DEFINE_string('annotations_dir', 'Annotation/train', 'Path to annotations directory.')
flags.DEFINE_string('output_path', '../tfrecord/RSOD_train.record', 'Path to output TFRecord')
flags.DEFINE_string('label_map_path', '../utils/RSOD_label_map.pbtxt',
