...
tf.app.flags.DEFINE_string('ckpt', 'model.quant.ckpt-1000', 'ckpt to be frozen')
tf.app.flags.DEFINE_string('output_node', 'resnet_v1_18/SpatialSqueeze', 'name of output name')
...
def freeze():
    ...
    logits = model.my_resnet(images, num_classes=NUM_CLASSES, depth_multiplier=DEPTH_MULTIPLIER, is_training=False)
